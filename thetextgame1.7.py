import os
os.system('cls')
os.system('title InkOnToast\'s 1.7 release ')
...
while True:
	...
	if choice == '1':
		...
		if type(level) != str:
			...
			lives = 3
			prngx = [4, 5, 8, 6, 7, 3, 5, 6, 3, 4, 6, 3, 7, 4, 1, 2, 5, 7, 2, 1, 6, 4, 8, 4, 7, 5, 5, 5, 4, 8, 3, 5, 7, 8, 1, 8, 6, 7, 3, 4, 6, 2, 1, 1, 8, 6, 3, 2, 3, 7, 1, 8, 2, 3, 2, 7, 8, 5, 4, 2, 1, 2, 1, 6, 6, 1, 2, 1, 2, 4, 5, 8, 7, 2, 3, 2, 8, 1, 7, 3, 2, 3, 6, 8, 1, 1, 2, 6, 4, 3, 7, 6, 8, 1, 8, 7, 5, 3, 8, 4, 5, 5, 5, 7, 4, 8, 4, 6, 1, 2, 7, 5, 2, 1, 4, 7, 3, 6, 4, 3, 6, 5, 3, 7, 6, 8, 5, 4]
